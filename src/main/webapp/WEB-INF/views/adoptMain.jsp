...
<div id="contentFrame">
      <div class = "adopt">
         ...
         <table id="selectTable">
            <td>
            <select id="animal" onchange="getAnimalType()"  name="animal_idx">
            ...
            <td>
            <select id="animalType" name="animal_type">
               <option value="선택" selected>선택</option>
               <option></option>
            </select>
            </td>
            ...
            <input type="button" id="searchBtn" onclick="adoptList(showPageNum)" value="검색"/>
         <table id="listTable" >
             <thead>
                <tr>
             ...
             <tr colspan="5">
             	<td>
            	<div id = "paging"></div>
         		<button id="writeBtn" onclick="location.href='./adoptForm'">글 작성</button>
         		<button id="ListBtn" onclick="location.href='./adoptMain'">전체 글 보기</button>
         		</td>
         	</tr>
         </table>
         </div>
