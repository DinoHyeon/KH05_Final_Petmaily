...
#loginFail {
   ...
   <div class="login">
      ...
      <form action="loginConfirmPage" method="post">
         ...
         <hr id="hr2"/>
       <input type="button" class="btn" id="searchBtn" onclick="location.href='loginSearchPage'" value="ID/PW 찾기"/>
         <h5 id="h5_3">아직 Petmily의 회원이 아니신가요?</h5>
         <input type="button" class="btn" id="joinBtn" onclick="location.href='joinPage'" value="회원 가입"/>
