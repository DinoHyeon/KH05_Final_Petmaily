      ...
      <form id="SearchPage" action="changePwPage" method="post">
         <table id="pwTable">
            <tr>
               ...
               <td colspan="3"><input type="password" class="inp" id="changePw" name="pw"
                  placeholder="비밀번호 입력" maxlength="20" /></td>
            </tr>
            <tr>
               <th style="font-size: 20">PW&nbsp;CHECK</th>
               <td><input type="password" class="inp" id="changePwChk" name="pwChk"
                  placeholder="비밀번호 확인" maxlength="20" /></td>
               <td><input type="button" id="pwChangeChk" class="btn" value="비밀번호확인"></td>
            </tr>
         </table>
         <input type="hidden" id="findId" name="changeId" /> 
         <input type="button" class="btn" id="ChangeBtn" value="변경하기" />
      </form>
   </div>
</body>
<script>
