	...
	<div class="LSP">
		...
		<form action="" method="post">
			<table id="idTable" style="left: 18%; top: 55%;">
				<tr>
					<th>이름</th>
					<td><input type="text" class="inp" id="nameSearch" name="name"
						placeholder="이름 입력" maxlength="20" /></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" class="inp" id="emailSearch"
						name="email" placeholder="아메일 입력" maxlength="20" /></td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td><input type="text" class="inp" id="phoneSearch"
						name="phone" placeholder="휴대폰번호 입력" maxlength="20" /></td>
				</tr>
				<tr>
					<td colspan="2"><input type="button" class="btn"
						id="idSearchBtn" value="아이디 찾기"
						style="left: 38%; width: 180px; margin: 50px auto auto auto;" /></td>
				</tr>
			</table>
		</form>
		...
		<form action="pwChangePage" method="post" id="pwChange">
			<table id="pwTable" style="left: 55%; top: 55%;">
				<tr>
					<th>아이디</th>
					<td><input type="text" class="inp" id="idSearch" name="pwId"
						placeholder="아이디 입력" maxlength="20" /></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" class="inp" id="pwEmailSearch"
						name="pwEmail" placeholder="아메일 입력" maxlength="20" /></td>
					<td><input type="button" class="btn" id="pwSearchEmailSend"
						value="인증번호 발송" /></td>
				</tr>
				<tr>
					<th>인증번호</th>
					<td><input type="text" class="inp" id="pwSearchEmailChk"
						name="pwSearchEmailChk" placeholder="인증번호 입력" maxlength="20" /></td>
					<td><input type="button" class="btn" id="pwSearchEmailConfirm"
						value="인증번호 확인" /></td>
				</tr>
				<tr>
					<td colspan="2"><input type="button" class="btn"
						id="pwSearchBtn" value="비밀번호 찾기"
						style="left: 42%; width: 180px; margin: 50px auto auto auto;" /></td>
				</tr>
			</table>
		</form>
