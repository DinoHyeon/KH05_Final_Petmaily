...
<body>
   ...
   <div id="conDiv">
      <div id="showDiv1">
         지금,<br />
         <br />
         <span id="spanId1"></span><span id="spanId1_1"> 마리가 주인을 찾고
            있습니다.</span>
      </div>
      <div id="showDiv2">
         <span id="spanId2_1"></span><span id="bgndeSpan"></span>~<span
            id="enddeSpan"></span>에<br />유기된 동물은 <br /> 총 <span id="spanId2"></span>
         마리 입니다. <br /> <br /> <input class="btnCls" type="button"
            onclick="prevDate()" value="◀이전기간" />
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input
            class="btnCls" type="button" onclick="nextDate()" value="다음기간▶" />
      </div>
      <div id="showDiv3">
         2018년, <br /> <span style='color: blue'>자연사 </span><span
            id="spanId3_1"></span><span style='color: black'>마리</span><br /> <span
            style='color: yellowgreen'>안락사 </span><span id="spanId3_2"></span><span
            style='color: black'>마리</span><br /> <span style='color: black'>그리고
         </span><span id="spanId3_3"></span><span style='color: black'>마리가 </span> <span
            style='color: orange'>입양</span><span style='color: black'>
            되었습니다.</span>
      </div>
      <div id="imgDiv">
         <img alt="버튼" id="sBtn1" onclick="fn_getFindHome()"
            src="resources/greyBtn.jpg">
         <!-- getFindHome -->
         <img alt="버튼" id="sBtn2" onclick="fn_cntDate()"
            src="resources/greyBtn.jpg">
         <!-- getTotalCount -->
         <img alt="버튼" id="sBtn3" onclick="fn_getAnimalCnt()"
            src="resources/greyBtn.jpg">
         <!-- getAnimalCnt -->
      </div>
      <hr />
      <br />
      <div id="bottomDiv">
         <span class="bottomTitle">새로운 </span><span id="bottomF">가족</span><span
            class="bottomTitle">을 찾습니다</span>
         <hr />
         <br /> <img alt="이전버튼" class="prevnext" onclick="fn_listM()"
            src="resources/prev.jpg"> <span id="listSpan"></span> <img
            alt="다음버튼" class="prevnext" onclick="fn_listP()"
            src="resources/next.jpg">
      </div>
      <br />
      <hr />
      <div id="lastDiv">
         <br />
         <span id="lastSpan">서비스 바로가기</span><br />
         <br /> <a href="./searchShelter"><img alt="보호센터찾기"
            src="resources/pCenter.jpg"></a> <a href="./missingList"><img
            alt="실종신고" src="resources/missing.jpg"></a> <a
            href="./protectList"><img alt="목격보호신고" src="resources/find.jpg"></a>
      </div>
   </div>
</body>
<script>
...
=======
   ...
   //로딩중
   function wrapWindowByMask() {
>>>>>>> 7cd64e853b3f98a97564dace430c77383f560f87
        //화면의 높이와 너비를 구한다.
