...
<body>
	...
	<div class="adopt">
		...
		<form id="saveUpdate" action="saveUpdate" name="saveUpdate" method="post">
			...
			<tr>
				...
				<table id="btnTable">
					<tr>
						<td>
						<input class="btn" type="button" value="수정"  id="btn_saveUpdate"  /> 
						<input class="btn" type="button"  value="취소" onclick="location.href='./saveMain'"  />
						</td>
					</tr>
				</table>
				</form>
