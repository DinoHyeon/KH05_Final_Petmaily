...
<body>
	...
	<div id="contentFrame">
		<div id=title>
			<h1 style="font-size: 30;">모금게시글 등록</h1>
		</div>
		<form id="sendForm" action="./writefundbbs" method="post">
			...
			<table id="writeTable">
				...
				<tr>
					<th id="noticef" colspan="2" style="background: #98C593;">※동물사진
						3장 , 영수증사진 1장 이상 첨부 필수※</th>
				</tr>
				<tr>
					<td colspan="2">
						<!-- div 에서 내용을 받아 보여준다. -->
				...
				<tr>
					<td colspan="3" style="height: 150px; border: 1px solid lightgray;"><div
							id="receiptList"></div></td>
				</tr>
				<tr>
					<td><input type="button" onclick="photoUp()" value="사진 첨부"
						id="frbtn" /></td>
				</tr>
				<tr>
					<td colspan="2">
						<!-- ./ 현재의 루트 --> &nbsp;&nbsp; <input id="savefund" type="button"
						value="글 저장" /> <input type="button" class="btn" id="back"
						value="취소">
...
<script>
	...
	function fileUp() {
		//fileUpload 새창을 띄운다.
		var myWin = window.open("./animalupload", "파일 업로드",
				"width=400, height=100");
	}

	function photoUp() {
		var myWin = window.open("./receiptUpload", "파일 업로드",
				"width=400, height=100");
	}
