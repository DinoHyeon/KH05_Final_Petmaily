			...
			<table id="joinTable">
				...
				<tr>
					<td colspan="2"><input type="button" class="btn"
						...
						style="left: 44.5%; margin: 60px auto auto auto; color: #28977B; border-top: 1.5px solid #28977B; border-right: 1.5px solid #217D65; border-bottom: 1.5px solid #217D65; border-left: 1.5px solid #28977B; background-color: white;" /></td>
				</tr>
			</table>
		</form>
	</div>
