	...
	<body>
		...
		<div id="conDiv">
			...
			<table id="detailTable" style="border:1px solid gray">
				<tr class = "littleTr">
					<th style="width:100px">작성자</th><td class="littleTd" style="width:500px">${cDetail.board_writer}</td>
					<th style="width:100px">작성일</th><td>${cDetail.board_regDate}</td>
				</tr>
				<tr class = "littleTr">
					<th style="width:100px">제　목</th><td class="littleTd" style="width:500px">${cDetail.board_title}</td>
					<th style="width:100px">조회수</th><td>${cDetail.board_hit}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					${cDetail.board_content}
					</td>
				</tr>
				<tr>
					<td colspan=4 style="text-align:right">
						<input type="button" id="upBtn" onclick="location.href='./communityUpdateForm?board_idx=${cDetail.board_idx}'" value="수정" />
						<input type="button" id="delBtn" onclick="communityDel()" value="삭제" />
						<input type="button" id="listBtn" value="글 목록" onclick="location.href='./communityMain'" />
					</td>
				</tr>
			</table>
		</div>
