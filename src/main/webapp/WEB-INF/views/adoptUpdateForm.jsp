				...
				<table id="writeTable">
					<tr>
						...
						<td><input id="board_writer" type="text" name="board_writer"
							readOnly value=${aUpdateForm.board_writer } /></td>
					</tr>
					<tr>
						<th style="width: 100px">제 목</th>
						<td><input id="board_title" type="text" name="board_title"
							value="${aUpdateForm.board_title}" onkeyup="chkword(this, 200)" /></td>
					</tr>
					<tr>
...
function del(elem){//이미지+버튼 삭제
	...
	//수정 버튼 클릭시
	$("#btn_adoptUpdate").click(function() {
