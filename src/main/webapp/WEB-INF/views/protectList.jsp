...
<body>
  <h3>보호 게시판</h3>
	...
	<div class="protectList">
	  <c:forEach items="${protectList}" var="protect">
		<table>
			<tr>
				<td id="board_idx">${protect.board_idx}</td>
				<td><a href="protectDetail?board_idx=${protect.board_idx}">${protect.board_title}</a></td>
			</tr>
			<tr>
				<td colspan="2"><img src="#">${protect.mainPhoto}</td>
			</tr>
		</table>
	  </c:forEach>
	</div>
