		...
		<div id="conDiv">
			...
			<table id="detailTable" style="border: 1px solid gray">
				<tr class="littleTr">
					...
					<td id="littleTd" style="width: 500px">${dto.board_writer }</td>
					<th style="width: 100px">작성일</th>
					<td id="ddate">${dto.board_regDate}</td>

				</tr>
				<tr class="littleTr">
					<th style="width: 100px">제 목</th>
					<td class="littleTd" style="width: 500px"><input type="text"
						id="title" name="subject" value="${dto.board_title}" /></td>
					<th style="width: 100px">조회수</th>
					<td>${dto.board_hit}</td>
				</tr>
				<tr>
				<tr>
					<th id="al" colspan='8' style="background: #217D65">※모금 게시판 사진
						수정 불가합니다※</th>
				</tr>
				...
				<tr>
					<td colspan=4 style="text-align: left; border: 1px solid gray;">
						...
						<!-- 전송은 hidden 에 담아서 한다. --> <input id="contentForm"
						type="hidden" name="content" />
					</td>
				<tr>
					<td colspan="3" style="text-align: right; border: 1px solid white;">
						<input id="cancle" type="button" onclick="home()" value="취소" /> <input
